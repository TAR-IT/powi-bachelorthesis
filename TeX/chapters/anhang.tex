...
Analyse genutzt wurden, sind gebündelt im folgenden GitHub Repository zu finden:

\vspace{0.5cm}

\centering\includegraphics[width=0.3\textwidth]{assets/qrcode_repository.png}\\
\centering\small\url{https://github.com/TAR-IT/bachelorthesis}

\vspace{0.5cm}

\begin{flushleft}
    Über diesen Link kommen Sie direkt zur Datei mit dem R-Code:
\end{flushleft}

\centering\includegraphics[width=0.3\textwidth]{assets/qrcode_codebook.png}\\
\centering\small\url{https://github.com/TAR-IT/bachelorthesis/blob/main/R/codebook.R}
