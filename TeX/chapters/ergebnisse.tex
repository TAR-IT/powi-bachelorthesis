% TODO: Bei deskriptiven Grafiken zitieren (Stand 04.03.2025)
...
Zusammenhang zwischen \textit{\ac{ICT}-Investitionen} und der Arbeitslosenquote. Im Vergleich zu den 
Basis-Modellen ohne Interaktionen zeigen sich hier mehrere signifikante Zusammenhänge, insbesondere mit 
institutionellen Faktoren wie dem Wohlfahrtsstaatentyp.

Die Interaktionseffekte zwischen \textit{\ac{ICT}-Investitionen} und den Wohlfahrtsstaaten liefern 
...
negativen Werte bedeuten, dass die negativen Auswirkungen von \ac{ICT}-Investitionen auf die Arbeitslosenquote 
...
Bei den Kontrollvariablen zeigt sich, dass das BIP pro Kopf weiterhin einen signifikanten negativen 
Einfluss auf die Arbeitslosenquote in allen Bildungsgruppen hat, unabhängig vom Wohlfahrtsstaatentyp. 
Die Gewerkschaftsdichte bleibt für niedrig- und mittelqualifizierte Personen positiv signifikant, 
