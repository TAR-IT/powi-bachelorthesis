% TODO: Alle Ergebnisse korrigieren...
% TODO: Bei deskriptiven Grafiken zitieren
...
die wichtigste Triebkraft für die Reduktion der Arbeitslosigkeit war. % TODO: Zitieren!
...
veränderten Bedingungen anzupassen. % TODO: Zitieren!
...
bestimmte Gruppen massiv benachteiligt wurden. % TODO: Zitieren!
...
Der \textit{Anteil tertiär gebildeter Personen} hat einen signifikanten positiven Effekt von 0,606** 
...
Die \textit{Gewerkschaftsdichte} weist mit einem Koeffizienten von 0,128** (p < 0,01) einen 
...
Die \textit{Regulierungsstrenge des Arbeitsmarkts} zeigt keinen signifikanten Effekt für diese Gruppe.
...
Der \textit{Anteil tertiär gebildeter Personen} weist einen signifikanten positiven Effekt von 0,282** 
(p < 0,01) auf, was darauf hindeutet, dass eine höhere tertiäre Bildungsbeteiligung mit strukturellen 
Arbeitsmarktveränderungen einhergeht.

Die \textit{Gewerkschaftsdichte} zeigt mit einem Koeffizienten von 0,106*** (p < 0,001) eine 
signifikante positive Korrelation mit der Arbeitslosenquote.

Die \textit{Regulierungsstrenge des Arbeitsmarkts} hat einen signifikant negativen Effekt von -0,118* 
...
Der \textit{Anteil tertiär gebildeter Personen} hat mit 0.140*** (p < 0,001) ebenfalls einen 
signifikant positiven Zusammenhang.

Die \textit{Gewerkschaftsdichte} hat in dieser Gruppe mit 0.025+ (p < 0,1) einen nur schwach 
signifikanten positiven Effekt.

Die \textit{Regulierungsstrenge des Arbeitsmarkts} zeigt mit einem Koeffizienten von -0,085* 
...
Der adjustierte R²-Wert liegt bei 0,295 (niedriges Bildungsniveau), 0,299 (mittleres 
Bildungsniveau) und 0,262 (hohes Bildungsniveau). Diese Werte zeigen, dass die Modelle stabil sind, 
...
\begin{itemize}
    ...
    \item \textbf{Anteil tertiär gebildeter Personen:} Der Koeffizient für den Anteil tertiär gebildeter 
...
Der adjustierte R²-Wert bleibt mit 0,327–0,297 weiterhin moderat, aber deutlich höher als 
