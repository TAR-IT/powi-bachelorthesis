...
\begin{acronym}[AAAAA] % Breite der längsten Abkürzung
  ...
  \acro{FE}{Feste Effekte (aus d. Engl.: \textit{Fixed Effects})}

  \acro{IaaS}{Infrastruktur als Dienstleistung (aus d. Engl.: \textit{Infrastructure 
  as a Service})}
  ...
  \acro{IT}{Informationstechnologie/-n (aus d. Engl.: \textit{Information 
  Technology})}
  ...
  \acro{PaaS}{Plattform als Dienstleistung (aus d. Engl.: \textit{Platform as a 
  Service})}

  \acro{RBTC}{Routinespezifischer technologischer Wandel (aus d. Engl.: 
  \textit{Routine-Biased Technological Change})}

  \acro{RE}{Zufällige Effekte (aus d. Engl.: \textit{Random Effects})}

  \acro{SaaS}{Software als Dienstleistung (aus d. Engl.: \textit{Software  
  as a Service})}

  \acro{SBTC}{Qualifikationsspezifischer technologischer Wandel (aus d. Engl.: 
  \textit{Skill-Biased Technological Change})}
 
  \acro{SNA08}{System der volkswirtschaftlichen Gesamtrechnung 2008 (aus d. Engl.: 
  \textit{System of National Accounts 2008})}
...
\begin{description}
  ...
  anstelle lokaler Server oder Computer \parencite[vgl.][S. 50–52]{armbrust2010aview}. 
  Dieses Modell ermöglicht den flexiblen Zugriff auf Daten und Anwendungen unabhängig vom 
  Standort und fördert Skalierbarkeit sowie Kosteneffizienz. Die wichtigsten Servicemodelle 
  sind \ac{IaaS}, \ac{PaaS} und \ac{SaaS} \parencite[vgl.][S. 50]{armbrust2010aview}.
  ...
  abhängige Variable beeinflusst wird \parencite[vgl.][S. 29-33]{pearl2009causality}. Dies 
  kann zu Fehlinterpretationen in statistischen Analysen führen, insbesondere in 
  nicht-experimentellen Studien. Reversed Causality tritt häufig in wirtschaftlichen und 
  sozialwissenschaftlichen Untersuchungen auf.
