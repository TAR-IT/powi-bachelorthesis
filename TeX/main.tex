...
\begin{acronym}[AAAAA] % Breite der längsten Abkürzung
  ...
  (aus d. Engl.: \textit{Artificial Intelligence})}

  \acro{BIP}{Bruttoinlandsprodukt}

  \acro{FE}{Feste Effekte 
  (aus d. Engl.: \textit{Fixed Effects})}

  \acro{IaaS}{Infrastruktur als Dienstleistung 
  (aus d. Engl.: \textit{Infrastructure as a Service})}
  
  \acro{ICT}{Informations- und Kommunikationstechnologien 
  (aus d. Engl.: \textit{Information and Communication Technologies})}

  \acro{IoT}{Internet der Dinge 
  (aus d. Engl.: \textit{Internet of Things})}

  \acro{IT}{Informationstechnologie/-n 
  (aus d. Engl.: \textit{Information Technology})}
  ...
  (aus d. Engl.: \textit{Platform as a Service})}

  \acro{RBTC}{Routinespezifischer technologischer Wandel 
  (aus d. Engl.: \textit{Routine-Biased Technological Change})}

  \acro{RE}{Zufällige Effekte 
  (aus d. Engl.: \textit{Random Effects})}

  \acro{SaaS}{Software als Dienstleistung 
  (aus d. Engl.: \textit{Software  as a Service})}

  \acro{SBTC}{Qualifikationsspezifischer technologischer Wandel 
  (aus d. Engl.: \textit{Skill-Biased Technological Change})}
 
  \acro{SNA08}{System der volkswirtschaftlichen Gesamtrechnung 2008 
  (aus d. Engl.: \textit{System of National Accounts 2008})}
...
\begin{description}
  ...
  beeinflusst wird \parencite[vgl.][S. 159–160]{pearl2009causality}. Dies kann zu 
